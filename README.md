...
## 2. PREPARE
### Data Storage:  
The dataset used for this project was provided as part of a Proof of Concept engagement.  All data was stored and managed within the company’s SharePoint environment and is not publicly available.
...
### Data Used:  
 We have been provided with 5 CSV files:
1. dim_customer.csv
2. dim_date.csv
3. dim_policies.csv
4. fact_premiums.csv
...
<img width="1272" height="672" alt="data modelling screenshot" src="https://github.com/user-attachments/assets/10bfacd2-c5e5-4227-a2fd-6317cf190bc8" />
